...
> **Статус:** TD-S4.2-07 (api-reference в pipeline) завершён
> **Блокеры:** нет
> **Что сделано:** ✅ Этап 1 (5/5), ✅ ADR-0020, ✅ TD-S4.2-07 (api-reference в config build + Gatherer)
> **Следующий шаг:** TD-S4.2-06 transitive closure → TD-S4.2-05 library add → TD-S4.2-02 codebase MCP
>
