...
> **Задача:** Этап 2 (Поиск и качество) — начат
> **Статус:** ADR-0020 написан, готов к реализации
> **Блокеры:** нет
> **Что сделано:** ✅ Этап 1 (5/5 задач), ✅ ADR-0020 (гибридный BM25+pgvector+RRF, 4-layer, BGE-M3)
> **Следующий шаг:** TD-S4.2-07 api-reference в pipeline → TD-S4.2-05 library add → TD-S4.2-02 codebase MCP
>
